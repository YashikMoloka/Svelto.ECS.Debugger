...
namespace Svelto.ECS.Debugger.Editor.ListViews
{
    public class WorldPopup
    {
        ...
        private readonly RootSelectionGetter _getWorldSelection;
        private readonly RootSelectionSetter _setWorldSelection;
        private readonly RootListGetter _rootListGetter;
